...
# This parser allows users to specify various settings like the model size and microphone settings.
def parse_arguments():
...
# This block of code sets up the microphone input for recording audio.
if 'linux' in platform:
...
# TODO#9 - Run the transcription in a separate thread
# This ensures that transcription happens in the background while Flask handles other tasks.
